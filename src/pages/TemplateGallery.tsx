      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          {filteredTemplates.map((template, index) => (
            <motion.div
              key={template.id}
              className="group bg-white rounded shadow hover:shadow-sm transition-all duration-300 overflow-hidden"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                  <div className="flex space-x-2">
                    <motion.button
                      ...
                      className="opacity-0 group-hover:opacity-100 px-4 py-2 bg-white text-black rounded font-medium transition-all duration-300"
                    ...
                    <motion.button
                      ...
                      className="opacity-0 group-hover:opacity-100 px-4 py-2 bg-black text-white rounded font-medium transition-all duration-300"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
              ...
              <div className="p-6">
                ...
                <motion.button
                  onClick={() => handleTemplateSelect(template)}
                  className="w-full px-4 py-3 bg-black text-white rounded font-medium  transition-all duration-300 flex items-center justify-center space-x-2"
                  whileHover={{ y: -1 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <span>使用此模板</span>
        ...
        {filteredTemplates.length === 0 && (
          ...
          >
            ...
            <button
              ...
              className="px-6 py-3 bg-black text-white rounded font-medium  transition-all duration-300"
            >
              重置筛选
            </button>
          </motion.div>
